...
const resources: Array<Resource> = [
  {
    ...
    name: 'Users',
    description:
      'Manage user profiles, retrieve user information, and update account status.',
    icon: UserIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  },
  {
    ...
    name: 'Sessions',
    description:
      'View active sessions, revoke individual sessions, or log out from all devices.',
    icon: BoltIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  },
  {
    ...
    description:
      'Role-based access control with fine-grained permission scopes for every ZB platform.',
    icon: CogIcon,
    pattern: {
      y: 32,
      squares: [
  ...
  {
    href: '/token-introspection',
    name: 'Token Introspection',
    description:
      'Validate and inspect access tokens for both user and service-to-service calls.',
    icon: BookIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
