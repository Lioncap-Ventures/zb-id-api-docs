...
<Note>
  These docs are interactive. Look for the "Try it" panels throughout, they run live against the ZB ID staging sandbox (id-staging.zb.co.zw). Register a throwaway account and sign in on the [Authentication](/authentication) page, and your token carries across the token-scoped panels.
</Note>
