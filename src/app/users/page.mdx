...
<TryIt
  method="GET"
  path="/users/me"
  title="Read your own profile"
  description="Uses the token from your last sign-in on the Authentication page. Returns the profile of the signed-in identity. With no token it returns 401."
  useToken
/>
