...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.get(
        'https://id.zb.co.zw/.well-known/jwks.json'
    )
...
<TryIt
  ...
  title="Fetch the live JWKS"
  description="Public endpoint, no token needed. Returns the current signing keys used to verify ZB ID access tokens on staging."
/>
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.get(
        'https://id.zb.co.zw/.well-known/openid-configuration'
    )
