...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://unified-zb-id-ynddvnxogq-lz.a.run.app/.well-known/jwks.json
    ```
    ...
    response = requests.get(
        'https://unified-zb-id-ynddvnxogq-lz.a.run.app/.well-known/jwks.json'
    )
...
<Row>
  <Col>
    ...
    <Properties>
      ...
      <Property name="grant_types_supported" type="array">
        List of OAuth grant types supported by ZB ID.
      </Property>
      <Property name="token_endpoint_auth_methods_supported" type="array">
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://unified-zb-id-ynddvnxogq-lz.a.run.app/.well-known/openid-configuration
    ```
    ...
    response = requests.get(
        'https://unified-zb-id-ynddvnxogq-lz.a.run.app/.well-known/openid-configuration'
    )
    ...
    ```json {{ title: 'Response' }}
    {
      "issuer": "https://unified-zb-id-ynddvnxogq-lz.a.run.app",
      "jwks_uri": "https://unified-zb-id-ynddvnxogq-lz.a.run.app/.well-known/jwks.json",
      "token_endpoint": "https://unified-zb-id-ynddvnxogq-lz.a.run.app/oauth/token",
      "introspection_endpoint": "https://unified-zb-id-ynddvnxogq-lz.a.run.app/oauth/introspect",
