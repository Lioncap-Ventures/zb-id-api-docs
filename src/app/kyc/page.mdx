...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.post(
        'https://id.zb.co.zw/v1/kyc/validate-id',
        headers={
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.post(
        'https://id.zb.co.zw/v1/kyc/credit-check',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
            'Content-Type': 'application/json',
        },
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.post(
        'https://id.zb.co.zw/v1/kyc/screen-individual',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
            'Content-Type': 'application/json',
        },
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.post(
        'https://id.zb.co.zw/v1/kyc/screen-corporate',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
            'Content-Type': 'application/json',
        },
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.post(
        'https://id.zb.co.zw/v1/kyc/screen-result',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
            'Content-Type': 'application/json',
        },
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.get(
        'https://id.zb.co.zw/v1/kyc/screen-toolkit',
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.post(
        'https://id.zb.co.zw/v1/kyc/screen-resolve',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
            'Content-Type': 'application/json',
        },
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.get(
        f'https://id.zb.co.zw/v1/kyc/verifications/{verification_id}',
        headers={'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...'}
    )
    ...
    const response = await fetch(
      `https://id.zb.co.zw/v1/kyc/verifications/${verificationId}`,
      {
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        },
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.get(
        'https://id.zb.co.zw/v1/kyc/verifications',
        headers={'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...'},
    ...
    const response = await fetch(
      `https://id.zb.co.zw/v1/kyc/verifications?${params}`,
      {
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        },
