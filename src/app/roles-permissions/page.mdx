...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.get(
        f'https://id.zb.co.zw/users/{user_id}/roles',
        headers={
    ...
    const response = await fetch(
      `https://id.zb.co.zw/users/${userId}/roles`,
      {
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9...',
        },
...
<Row>
  ...
  <Col sticky>
    ...
    response = requests.delete(
        f'https://id.zb.co.zw/users/{user_id}/roles/{role_name}',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9...'
        }
    )
    ...
    const response = await fetch(
      `https://id.zb.co.zw/users/${userId}/roles/${roleName}`,
      {
        method: 'DELETE',
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9...',
