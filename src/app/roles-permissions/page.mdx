...
<Row>
  <Col>
    ...
    These scopes are granted to OAuth clients (via the client credentials grant) that call the [central KYC endpoints](/kyc).

    <Properties>
      <Property name="kyc:validate" type="scope">
        Validate national IDs against the e-Gov registry.
      </Property>
      <Property name="kyc:credit-check" type="scope">
        Run FCB credit bureau searches.
      </Property>
      <Property name="kyc:screen" type="scope">
  ...
  <Col>
    ...
    <Properties>
      <Property name="roleName" type="string">
        The name of the role to assign (e.g., `customer`, `merchant`, `staff`, `admin`, `auditor`, `driver`, or a custom role name).
      </Property>
