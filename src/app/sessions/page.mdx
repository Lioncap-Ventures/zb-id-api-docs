...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://zbid-api.lioncapventures.com/sessions \
    ...
    response = requests.get(
        'https://zbid-api.lioncapventures.com/sessions',
        headers={
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://zbid-api.lioncapventures.com/sessions/b2c3d4e5-f6a7-8901-bcde-f12345678901 \
      -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIs..."
    ```
    ...
    response = requests.delete(
        f'https://zbid-api.lioncapventures.com/sessions/{session_id}',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        }
    )
    ...
    const response = await fetch(
      `https://zbid-api.lioncapventures.com/sessions/${sessionId}`,
      {
        method: 'DELETE',
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://zbid-api.lioncapventures.com/auth/logout \
      -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIs..."
    ```
    ...
    response = requests.post(
        'https://zbid-api.lioncapventures.com/auth/logout',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        }
    )
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://zbid-api.lioncapventures.com/auth/logout/all \
      -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIs..."
    ```
    ...
    response = requests.post(
        'https://zbid-api.lioncapventures.com/auth/logout/all',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        }
    )
