...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://unified-zb-id-ynddvnxogq-lz.a.run.app/sessions \
    ...
    response = requests.get(
        'https://unified-zb-id-ynddvnxogq-lz.a.run.app/sessions',
        headers={
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://unified-zb-id-ynddvnxogq-lz.a.run.app/sessions/b2c3d4e5-f6a7-8901-bcde-f12345678901 \
      -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIs..."
    ```
    ...
    response = requests.delete(
        f'https://unified-zb-id-ynddvnxogq-lz.a.run.app/sessions/{session_id}',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        }
    )
    ...
    const response = await fetch(
      `https://unified-zb-id-ynddvnxogq-lz.a.run.app/sessions/${sessionId}`,
      {
        method: 'DELETE',
        headers: {
          'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://unified-zb-id-ynddvnxogq-lz.a.run.app/auth/logout \
      -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIs..."
    ```
    ...
    response = requests.post(
        'https://unified-zb-id-ynddvnxogq-lz.a.run.app/auth/logout',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        }
    )
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://unified-zb-id-ynddvnxogq-lz.a.run.app/auth/logout/all \
      -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIs..."
    ```
    ...
    response = requests.post(
        'https://unified-zb-id-ynddvnxogq-lz.a.run.app/auth/logout/all',
        headers={
            'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIs...',
        }
    )
