  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name="400" type="Bad Request">
        `clientId` was missing or blank; or neither `userId` nor `email` was supplied; or `clientId` names an app that is not registered, which answers `BAD_REQUEST` with the message `Unknown clientId`.
      </Property>
